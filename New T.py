...
connect=mysql.connector.connect(host="localhost",port="3306",user="root",password="Praveen@123",database="bank",auth_plugin='mysql_native_password')
...
while ch != 8:
    ...
    if ch == '1':
        ...
        print("\t__________________THANKS FOR USING PRAVEEN BANK MANAGEMENT MINI PROJECT_______________________")
        break
    else :
        print("Invalid choice")
